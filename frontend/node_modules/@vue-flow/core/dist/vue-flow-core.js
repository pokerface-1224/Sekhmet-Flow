...
const _sfc_main$a = /* @__PURE__ */ vue.defineComponent({
  ...
  setup(__props) {
    ...
    const container = vue.shallowRef(null);
    const selectedNodeIds = vue.shallowRef(/* @__PURE__ */ new Set());
    const selectedEdgeIds = vue.shallowRef(/* @__PURE__ */ new Set());
    const containerBounds = vue.shallowRef(null);
