...
declare const _default: __VLS_WithTemplateSlots<import("vue").DefineComponent<{
    ...
    emits: Readonly<{
        ...
        error: import("@vueuse/shared").EventHookTrigger<import("../..").VueFlowError<import("../..").ErrorCode, [] | [id?: string | undefined] | [id: string | null] | [id: string, parentId: string] | [type: string] | [id: string] | [id: string] | [id: string, source: string] | [id: string, target: string] | [type: string] | [id: string, source: string, target: string] | [id: string, source: string, target: string] | [id: string] | [id: string]>>;
    }>;
    ...
    onError: import("@vueuse/shared").EventHookOn<import("../..").VueFlowError<import("../..").ErrorCode, [] | [id?: string | undefined] | [id: string | null] | [id: string, parentId: string] | [type: string] | [id: string] | [id: string] | [id: string, source: string] | [id: string, target: string] | [type: string] | [id: string, source: string, target: string] | [id: string, source: string, target: string] | [id: string] | [id: string]>>;
    ...
    startConnection: (startHandle: import("../../types").ConnectingHandle, position?: import("../../types").XYPosition | undefined, isClick?: boolean | undefined) => void;
    ...
    getIncomers: (nodeOrId: string | import("../../types").Node<any, any, string>) => import("../../types").GraphNode<any, any, string>[];
    getOutgoers: (nodeOrId: string | import("../../types").Node<any, any, string>) => import("../../types").GraphNode<any, any, string>[];
    getConnectedEdges: (nodesOrId: string | import("../../types").Node<any, any, string>[]) => import("../../types").GraphEdge[];
    getHandleConnections: ({ id, type, nodeId }: {
    ...
    error: (error: import("../..").VueFlowError<import("../..").ErrorCode, [] | [id?: string | undefined] | [id: string | null] | [id: string, parentId: string] | [type: string] | [id: string] | [id: string] | [id: string, source: string] | [id: string, target: string] | [type: string] | [id: string, source: string, target: string] | [id: string, source: string, target: string] | [id: string] | [id: string]>) => void;
    connect: (connectionEvent: import("../../types").Connection) => void;
    connectStart: (connectionEvent: {
        event?: MouseEvent | undefined;
    } & import("../../types").OnConnectStartParams) => void;
    ...
    onError?: ((error: import("../..").VueFlowError<import("../..").ErrorCode, [] | [id?: string | undefined] | [id: string | null] | [id: string, parentId: string] | [type: string] | [id: string] | [id: string] | [id: string, source: string] | [id: string, target: string] | [type: string] | [id: string, source: string, target: string] | [id: string, source: string, target: string] | [id: string] | [id: string]>) => any) | undefined;
    onMove?: ((moveEvent: {
        event: import("d3-zoom").D3ZoomEvent<HTMLDivElement, any>;
        flowTransform: import("../../types").ViewportTransform;
    }) => any) | undefined;
    ...
    onConnectStart?: ((connectionEvent: {
        event?: MouseEvent | undefined;
    } & import("../../types").OnConnectStartParams) => any) | undefined;
