...
import type { Dimensions, ElementData, Elements, FlowElements, FlowExportObject, FlowImportObject, FlowOptions, FlowProps, Rect, SelectionMode, SelectionRect, SnapGrid, XYPosition } from './flow';
import type { DefaultEdgeTypes, DefaultNodeTypes, EdgeComponent, NodeComponent } from './components';
import type { Connection, ConnectionLineOptions, ConnectionLineType, ConnectionLookup, ConnectionMode, ConnectionStatus, Connector, HandleConnection } from './connection';
...
export type RemoveNodes = (nodes: (string | Node) | (Node | string)[] | ((nodes: GraphNode[]) => (string | Node) | (Node | string)[]), removeConnectedEdges?: boolean, removeChildren?: boolean) => void;
...
export type UpdateEdgeData = <Data = ElementData, CustomEvents extends Record<string, CustomEvent> = any>(id: string, dataUpdate: Partial<Data> | ((edge: GraphEdge<Data, CustomEvents>) => Partial<Data>), options?: {
    replace: boolean;
}) => void;
...
export type UpdateNode = <Data = ElementData, CustomEvents extends Record<string, CustomEvent> = any>(id: string, nodeUpdate: Partial<Node<Data, CustomEvents>> | ((node: GraphNode<Data, CustomEvents>) => Partial<Node<Data, CustomEvents>>), options?: {
    replace: boolean;
}) => void;
export type UpdateNodeData = <Data = ElementData, CustomEvents extends Record<string, CustomEvent> = any>(id: string, dataUpdate: Partial<Data> | ((node: GraphNode<Data, CustomEvents>) => Partial<Data>), options?: {
    replace: boolean;
}) => void;
