...
import type { Connection, ConnectionLineOptions, ConnectionLineProps, ConnectionLineType, ConnectionMode, Connector, OnConnectStartParams } from './connection';
...
export interface FlowEmits {
    ...
    (event: 'selectionContextMenu', selectionEvent: {
        event: MouseEvent;
        nodes: GraphNode[];
    }): void;
    ...
    (event: 'paneClick' | 'paneContextMenu' | 'paneMouseEnter' | 'paneMouseMove' | 'paneMouseLeave', paneMouseEvent: MouseEvent): void;
    (event: 'edgeUpdate', edgeUpdateEvent: EdgeUpdateEvent): void;
    (event: 'edgeContextMenu' | 'edgeMouseEnter' | 'edgeMouseMove' | 'edgeMouseLeave' | 'edgeDoubleClick' | 'edgeClick' | 'edgeUpdateStart' | 'edgeUpdateEnd', edgeMouseEvent: EdgeMouseEvent): void;
    (event: 'nodeContextMenu' | 'nodeMouseEnter' | 'nodeMouseMove' | 'nodeMouseLeave' | 'nodeDoubleClick' | 'nodeClick', nodeMouseEvent: NodeMouseEvent): void;
    (event: 'nodeDragStart' | 'nodeDrag' | 'nodeDragStop', nodeDragEvent: NodeDragEvent): void;
    (event: 'miniMapNodeClick' | 'miniMapNodeDoubleClick' | 'miniMapNodeMouseEnter' | 'miniMapNodeMouseMove' | 'miniMapNodeMouseLeave', nodeMouseEvent: NodeMouseEvent): void;
